                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-title">
                                <h5>Add a Product Category</h5>
                            </div>
                            <div class="ibox-content">
                                <form id="form" role="form" action="/controller/controller_addcategory.php" method="POST" enctype="multipart/form-data" class="wizard-big">
                                    <h1>Category Info</h1>
                                    <fieldset>
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    <label>Name:</label>
                                                    <input id="userName" name="name" type="text" class="form-control required" placeholder="Category Name">
                                                </div>
                                                <div class="form-group">
                                                    <label>Description:</label>
                                                    <input id="userName" name="description" type="text" class="form-control required" placeholder="Category Description">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
