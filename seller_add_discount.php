                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-title">
                                <h5>Add Your Discount Details</h5>
                            </div>
                            <div class="ibox-content">
                                <h2>
                                    Please Enter Your Data Correctly.
                                </h2>
                                <form id="form" role="form" action="/controller/controller_upload_discount.php" method="POST" enctype="multipart/form-data" class="wizard-big">
                                    <h1>Product Info</h1>
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    ...
                                                    <input id="userName" name="discount" type="text" class="form-control required" placeholder="Discount">
                                                </div>
                                                <div class="form-group">
                                                    <label>Status:</label>
