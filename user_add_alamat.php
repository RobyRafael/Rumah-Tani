                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                ...
                                <form id="form" role="form" action="/controller/controller_upload_address.php" method="POST" enctype="multipart/form-data" class="wizard-big">
                                    <h1>Address Info</h1>
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    <label>Address:</label>
                                                    <input id="userName" name="address" type="text" class="form-control required" placeholder="Address">
                                                </div>
                                                <div class="form-group">
                                                    <label>City:</label>
                                                    <input id="userName" name="city" type="text" class="form-control required" placeholder="City">
                                                </div>
                                                <div class="form-group">
                                                    <label>Postal Code:</label>
                                                    <input id="userName" name="postal" type="text" class="form-control required" placeholder="Postal Code">
                                                </div>
                                                <div class="form-group">
                                                    <label>Phone:</label>
                                                    <input id="userName" name="phone" type="text" class="form-control required" placeholder="Mobile Phone">
                                                </div>
                                            </div>
