        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="admin_dashboard.php"><i class="fa fa-dashboard"></i> <span class="nav-label">Dashboard</span></a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-product-hunt"></i> <span class="nav-label">Product Categories</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="admin_category.php">Categories</a></li>
                            <li><a href="admin_add_category.php">Add a category</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="admin_listuser.php"><i class="fa fa-address-book"></i> <span class="nav-label">List Users</span></a>
                    </li>
                    <li>
                    ...
                    <form id="form" role="form" action="/controller/controller_editsavedelete.php" method="POST" class="wizard-big">
                        <table id='a' class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><input type="checkbox" name="delete_ids[]" value="<?php echo $product['id_user']; ?>"></td>
                                        <td><?php echo $no++; ?></td>
                                        <td><?= $product['name'] ?></td>
                                        ...
                                        <td>
                                            <img src="<?= "dokumen/" . $product['foto'] ?>" alt="" style="width: 50px; height: 50px;">
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
