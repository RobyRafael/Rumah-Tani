        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="seller_mailbox.php"><i class="fa fa-inbox"></i> <span class="nav-label">Messages</span></a>
                    </li>
                    <li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                ...
                                <form id="form" role="form" action="/controller/controller_editprofile.php" method="POST" enctype="multipart/form-data" class="wizard-big">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    <label>Name:</label>
                                                    <input id="userName" name="name" type="text" class="form-control required" placeholder="Your Name" value="<?= $user['name'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label>Name Toko:</label>
                                                    <input id="storeName" name="nama_toko" type="text" class="form-control required" placeholder="Store Name" value="<?= $user['nama_toko'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label>Email:</label>
                                                    <input id="userEmail" name="username" type="text" class="form-control required" placeholder="Email" value="<?= $user['username'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label>Description:</label>
                                                    <input id="userDescription" name="description" type="text" class="form-control required" placeholder="Description" value="<?= $user['description'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label>Address:</label>
                                                    <input id="userAddress" name="address" type="text" class="form-control required" placeholder="Address" value="<?= $user['address'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
