                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-title">
                                <h5>Add Your Product Details</h5>
                            </div>
                            <div class="ibox-content">
                                <h2>
                                    Please Enter Your Data Correctly.
                                </h2>
                                <form id="form" role="form" action="/controller/controller_uploadphoto.php" method="POST" enctype="multipart/form-data" class="wizard-big">
                                    <h1>Product Info</h1>
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    <label>Name:</label>
                                                    <input id="userName" name="name" type="text" class="form-control required" placeholder="Product Name">
                                                </div>
                                                <div class="form-group">
                                                    <label>Price (/Kg):</label>
                                                    <input id="userName" name="price" type="text" class="form-control required" placeholder="Price">
                                                </div>
                                                <div class="form-group">
                                                    <label>Description:</label>
                                                    <input id="userName" name="description" type="text" class="form-control required" placeholder="Description">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="category" id="category" class="form-control">
                                                        ...
                                                        $query = "SELECT id_category, name FROM product_category";
